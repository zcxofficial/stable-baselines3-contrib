...
from sb3_contrib.A3C_mask.policies import CnnPolicy, MlpPolicy, MultiInputPolicy

SelfMaskableA3C = TypeVar("SelfMaskableA3C", bound="MaskableA3C")


class MaskableA3C(OnPolicyAlgorithm):
    """
